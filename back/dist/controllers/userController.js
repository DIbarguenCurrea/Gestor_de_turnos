...
const getUserById = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
        const foundUser = yield (0, userService_1.getUserByIdServices)(Number(id));
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const loginCredential = yield (0, credentialServices_1.validateCredential)({
            username, password
        });
        const user = yield (0, userService_1.findUserByCredentialId)(loginCredential.id);
